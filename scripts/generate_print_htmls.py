...
<script>
    document.addEventListener('DOMContentLoaded', async () => {{
        ...
        const parsedHtml = marked.parse(processedLines.join('\\n'));
...
<style>
    ...
    h1 {{ font-size: 2.5em; border-bottom: 2px solid #30363d; padding-bottom: 10px; margin-bottom: 20px; }}
    h2 {{ font-size: 2em; border-bottom: 1px solid #30363d; padding-bottom: 8px; margin-bottom: 16px; }}
    h3 {{ font-size: 1.8em; margin-bottom: 10px; }}
    h4 {{ font-size: 1.4em; color: #ff8c00; margin-top: 0; margin-bottom: 20px; }}
    p {{ font-size: 1.25em; line-height: 1.5; }}
    ul {{ font-size: 1.25em; line-height: 1.6; margin-top: 10px; }}
    code {{
...
<script>
    document.addEventListener('DOMContentLoaded', async () => {{
        ...
        for (let rawSlide of rawSlides) {{
            ...
            const parsedSlideHtml = marked.parse(processedLines.join('\\n'));
